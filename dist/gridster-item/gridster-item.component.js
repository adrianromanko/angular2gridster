...
var GridsterItemComponent = (function () {
    function GridsterItemComponent(zone, elementRef, gridster) {
        ...
        this.xHDChange = new core_1.EventEmitter();
        this.yHDChange = new core_1.EventEmitter();
...
GridsterItemComponent.propDecorators = {
    ...
    'xHD': [{ type: core_1.Input },],
    'xHDChange': [{ type: core_1.Output },],
    'yHD': [{ type: core_1.Input },],
    'yHDChange': [{ type: core_1.Output },],
    'w': [{ type: core_1.Input },],
