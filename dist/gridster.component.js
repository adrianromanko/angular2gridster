...
var GridsterComponent = (function () {
    ...
    GridsterComponent.prototype.ngOnInit = function () {
        ...
        var changeSub = this.gridsterOptions.change
            .do(function (options) {
        ...
        var resizeSub = Observable_1.Observable.fromEvent(window, 'resize')
            .debounceTime(this.gridster.options.responsiveDebounce || 0)
            .filter(function () { return _this.gridster.options.responsiveView; })
            .subscribe(function () {
            _this.reload();
        });
        ...
        this.zone.runOutsideAngular(function () {
            ...
            _this.subscription.add(scrollSub);
        });
    };
